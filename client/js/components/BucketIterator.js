...
Meteor.startup( function() { 
  // Factory method for a Scheduler.BucketIterator
  Scheduler.BucketIterator = function( buckets ) {
    this.setBuckets( buckets );
    this.reset();
    this.scheduleValidator = new Scheduler.ScheduleValidator([]);
  ...
  Scheduler.BucketIterator.prototype.hasValidSchedules = function() {
  ...
  Scheduler.BucketIterator.prototype.setBuckets = function( buckets ) {
  ...
  Scheduler.BucketIterator.prototype.reset = function() {
    this.position = 1;
  ...
  Scheduler.BucketIterator.prototype.maxReset = function() {
  ...
  Scheduler.BucketIterator.prototype.setPosition = function(pos) {
  ...
  Scheduler.BucketIterator.prototype.coursesAreValid = function(courses) {
  ...
  Scheduler.BucketIterator.prototype.isValid = function(pos) {
  ...
  //     pos     = [ [ 1 ],          [ 0 ],      [ 0 ]  ] => { c2, c4, c5 }
  Scheduler.BucketIterator.prototype.inc = function(pos) {
  ...
  Scheduler.BucketIterator.prototype.dec = function(pos) {
    if( this.buckets.length == 0 ) {
      return;
    }
  ...
  Scheduler.BucketIterator.prototype.getCourseArray = function() {
    var result = [];
  ...
  Scheduler.BucketIterator.prototype.getSchedule = function() {
    var result = [];
