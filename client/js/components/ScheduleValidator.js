// Scheduler.ScheduleValidator.js

Meteor.startup( function() {

  /* Prototype methods */

  Scheduler.ScheduleValidator = function(scheduleFilters) {
      this.scheduleFilters = scheduleFilters || [];
  //    this.scheduleFilters.push(new Scheduler.ScheduleFilter()); // testing filter
  }

  Scheduler.ScheduleValidator.prototype.scheduleIsValid = function(schedule) {
  ...
  Scheduler.ScheduleValidator.prototype.scheduleHasNoTimeOverlap = function(courses) {
  ...
  Scheduler.ScheduleValidator.prototype.daysForRenderPackets = function(renderPackets) {
      var days = {};
  ...
  Scheduler.ScheduleValidator.prototype.daysHaveTimeOverlap = function(days) {
      for( day in days ) {
          day = days[day];
  ...
  Scheduler.ScheduleValidator.prototype.daysOverlap = function(firstDay, secondDay) {
  ...
  Scheduler.ScheduleValidator.prototype.schedulePassesFilters = function(schedule) {
